...
bool Problem::AddVertex(std::shared_ptr<Vertex> vertex) {
    if (verticies_.find(vertex->Id()) != verticies_.end()) { //如果未找到vertex
...
void Problem::MakeHessian() {
    ...
    // std::cout << "size:" << size << " ordering_poses_:" << ordering_poses_ << " ordering_landmarks_:" << ordering_landmarks_ << std::endl;
    ...
    // std::cout << H_prior_.rows() << std::endl;
